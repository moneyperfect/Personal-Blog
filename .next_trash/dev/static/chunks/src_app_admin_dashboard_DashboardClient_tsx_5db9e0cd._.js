...
function DashboardClient() {
    ...
    // 图表数据状态
    const [trafficData, setTrafficData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([
        {
            date: '1月1日',
            visits: 4000,
            pageviews: 2400
    ...
    const [topNotesData, setTopNotesData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    // 根据笔记数据更新图表
    const updateChartsFromNotes = (notesData)=>{
        // 更新分类分布图
        const categoryCount = {};
        ...
        // 更新热门笔记图（模拟视图数据）
        const newTopNotesData = notesData.slice(0, 5) // 取前5个
        .map((note)=>({
    ...
    // 辅助函数：获取笔记数据用于统计
    const fetchNotesForStats = async ()=>{
        try {
            const response = await fetch('/api/admin/notes');
            if (!response.ok) {
                throw new Error(`HTTP error! status: ${response.status}`);
    ...
    const toggleNoteEnabled = async (id)=>{
        try {
            const response = await fetch('/api/admin/notes', {
                method: 'POST',
                headers: {
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                ...
                                                className: `inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium ${activeTab === 'overview' ? 'border-primary-500 text-gray-900' : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700'}`,
                                                children: "概览"
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/admin/dashboard/DashboardClient.tsx",
                                                lineNumber: 272,
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                ...
                                                className: `inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium ${activeTab === 'notes' ? 'border-primary-500 text-gray-900' : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700'}`,
                                                children: "笔记管理"
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/admin/dashboard/DashboardClient.tsx",
                                                lineNumber: 282,
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                ...
                                                className: `inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium ${activeTab === 'analytics' ? 'border-primary-500 text-gray-900' : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700'}`,
                                                children: "流量分析"
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/admin/dashboard/DashboardClient.tsx",
                                                lineNumber: 292,
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                                ...
                                                children: notes.map((note)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                                ...
                                                                children: note.language === 'zh' ? '中文' : '日语'
                                                            }, void 0, false, {
                                                                fileName: "[project]/src/app/admin/dashboard/DashboardClient.tsx",
                                                                lineNumber: 512,
                                                                columnNumber: 25
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                                className: "px-6 py-4 whitespace-nowrap",
                                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                    className: `px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${note.enabled ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`,
                                                                    children: note.enabled ? '已发布' : '未发布'
                                                                }, void 0, false, {
                                                                    fileName: "[project]/src/app/admin/dashboard/DashboardClient.tsx",
                                                                    lineNumber: 519,
                                                                    columnNumber: 27
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                                ...
                                                                children: [
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                                        ...
                                                                        className: `mr-3 ${note.enabled ? 'text-red-600 hover:text-red-900' : 'text-green-600 hover:text-green-900'}`,
                                                                        children: note.enabled ? '取消发布' : '发布'
                                                                    }, void 0, false, {
                                                                        fileName: "[project]/src/app/admin/dashboard/DashboardClient.tsx",
                                                                        lineNumber: 528,
                                                                        columnNumber: 27
...
_s(DashboardClient, "cAUQv5WR1zehNISsmAsURUBLFy0=", false, function() {
    return [
