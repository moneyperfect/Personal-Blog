  ...
  const SidebarContent = () => (
    <div className="flex h-full flex-col bg-slate-50 border-r border-slate-200">
      ...
      <div className="flex-1 overflow-y-auto px-4 py-6 space-y-1">
        ...
        {[
          { label: '概览', href: '/admin/dashboard', icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z' },
          ...
          { label: '产品管理', href: '/admin/products', icon: 'M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4' },
        ].map((item) => {
